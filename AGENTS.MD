...
- macOS app profiling/testing: sign local bundles with the matching Developer ID identity before launch; never use unsigned/ad-hoc builds against saved Keychain items. Keep release keychains out of the default search list; unlock and pass them explicitly.
